...
| PATCH | `/v1/navigation/{navigationId}/up` | ⬜ [move_navigation_up.md](/doc/api/navigation/move_navigation_up.md) |
| PATCH | `/v1/navigation/{navigationId}/down` | ⬜ [move_navigation_down.md](/doc/api/navigation/move_navigation_down.md) |
