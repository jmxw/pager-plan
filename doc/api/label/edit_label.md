...
changed, no request DTO is declared, and no service is called. This doc records the declared
...
| --- | --- | --- |
| `labelId` | Long | Id of the [label](/doc/tech_noun/TN0303_label.md) to edit. |
