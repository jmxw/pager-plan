...
Delete the content of a label for a language.

**Stub endpoint** — the handler body is empty: no [label](/doc/tech_noun/TN0303_label.md) content
is deleted and no service is called. This doc records the declared surface; it is extended
...
| --- | --- | --- |
| `labelId` | Long | Id of the [label](/doc/tech_noun/TN0303_label.md) whose per-language content is deleted. |
