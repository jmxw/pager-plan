...
Add a customer user. A new [user](/doc/tech_noun/TN0202_user.md) is created with the `CUSTOMER` role
in the caller's [organization](/doc/tech_noun/TN0201_organization.md). The plaintext password is
...
The role is fixed to `CUSTOMER` by the controller and is not read from the request body.
...
{
  "organizationId": 1,
  "identifier": "cust-chen",
  "name": "陈客户",
  "password": "P@ssw0rd!",
  "mail": "cust-chen@monstar-lab.com"
}
```
