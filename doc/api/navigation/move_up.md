# PATCH /v1/navigation/{navigationId}/up

> Controller: NavigationController

Move [navigation](/doc/tech_noun/TN0601_navigation.md) menu up

The navigation menu is swapped in sequence with the sibling immediately before it under the same parent.
When the navigation menu has no parent or is already first, the request succeeds with no change.
...
| --- | --- | --- |
| `navigationId` | Long | Physical id of the navigation menu to move up. |
